...
The wrappers aim for a drop-in replacement for the scene classes, but there unfortunately are few compromises you have to be aware of:
...
```py
self.next_normal_slide("human readable name of the slide (doesn't have to be unique)")
```
